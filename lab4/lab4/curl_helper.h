...
#include <search.h> // for hashtable

#include "node.h" // for linkedlist
...
int find_http(char *fname, int size, int follow_relative_links, const char *base_url, url_node * htmlz);
