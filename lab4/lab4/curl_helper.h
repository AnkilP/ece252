...
int find_http(char *fname, int size, int follow_relative_links, const char *base_url, url_node ** htmlz, Hashtable ** all_visited_urls, pthread_rwlock_t * visitedStack, pthread_mutex_t * frontier_lock);
